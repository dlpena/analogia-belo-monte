...
Diferença em relação ao projeto Hidrovias: aqui o histórico de TELEMETRIA também
é congelado, porque a estação deste projeto (18821000) não tem dados no banco
HIDRO — toda a série vem da telemetria (ago/2014 em diante).
...
- Telemetria: congela até F_t = 1/jan do ano anterior - 1 dia (telemetria antiga
  não muda); rodada normal consulta de F_t + 1 em diante.
- Reconsistência/retificação retroativa só entra com --full (recomendado ~1x/ano).
"""
